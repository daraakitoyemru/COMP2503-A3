...
public class BST<T extends Comparable<T>> implements Iterable<T> {
   ...
   class BSTNode implements Comparable<BSTNode> {
       ...
       * A leaf node is defined as a node with no children, i.e., both its left and
   ...
   /**
    * Iterator class for a binary search tree (BST) that traverses the tree in an
    * inorder manner.
   ...
   private BSTNode delete(BSTNode root, BSTNode n) {
      ...
      int c = compare(n.getData(), root.getData());
    ...
    *
    * @param root          The root node of the BST.
    * @param traversalType The type of traversal to perform (e.g., INORDER, PREORDER,
    ...
    * In this traversal, the left subtree is visited first, then the current node, and
    ...
    * In this traversal, the current node is visited first, then the left subtree, and
    * finally the right subtree.
    *
    * @param r The root node of the current subtree.
    */
    ...
    * In this traversal, the left subtree is visited first, then the right subtree, and
